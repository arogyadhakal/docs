...
```bash cURL
curl -X POST "https://your-api-domain.com/api/v1/extract" \
...
const response = await fetch("https://your-api-domain.com/api/v1/extract", {
  method: "POST",
  headers: {
...
url = "https://your-api-domain.com/api/v1/extract"
headers = {
    "Authorization": "Bearer pk_live_your_api_key",
    "Idempotency-Key": "unique-request-id-123"
}
